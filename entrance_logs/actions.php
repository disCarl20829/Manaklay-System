...
// Put this snippet alongside your other actions (add, edit, checkout, delete) inside actions.php
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $action = $_POST['action'] ?? '';

    switch ($action) {
        // ... Your existing cases (add, edit, etc) ...

        case 'update_payment':
            $customer_id = $_POST['customer_id'];
            $entrance_fee = floatval($_POST['entrance_fee']);
            $accommodation_fee = floatval($_POST['accommodation_fee']);
