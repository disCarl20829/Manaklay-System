...
<head>
    ...
    <title>Accounting & Inventory System - Settings</title>
            ...
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <form onsubmit="return false;">
                        <div class="form-group"><label>Shop Name</label><input type="text"
                                value="Manaklay Beach & Park Resort" class="form-control"></div>
                        <div class="form-group"><label>Address</label><input type="text"
                                placeholder="Enter shop address" class="form-control"></div>
                        <div class="form-group"><label>Contact Number</label><input type="text"
                                placeholder="Enter contact number" class="form-control"></div>
