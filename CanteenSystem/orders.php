...
if (isset($_POST['action'])) {
    ...
    if ($_POST['action'] == 'add_order') {
        ...
        try {
            $sql = "INSERT INTO orders (due_date, notes, user_id, order_status, payment_status) 
                    VALUES ($due_date, '$notes', '$user_id', 'pending', 'unpaid')";
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#ordersList').html('<tr><td colspan="9" class="text-center">Error loading orders</td></tr>');
                    }
                }
            });
        }
